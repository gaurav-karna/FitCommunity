# Generated by Django 2.1.4 on 2019-01-27 15:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Required_Email', models.CharField(blank=True, max_length=64, null=True, unique=True, verbose_name='Is there a specific email address you would like your members to have? (format like @example.tld')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Registration_Deadline', models.DateTimeField(verbose_name='Deadline for Registration')),
                ...
                ('Event_Details', models.TextField(blank=True, max_length=2000, verbose_name='(Optional) Event Details - Please keep this to under 2000 characters.')),
                ('Community', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='FitApp.Community')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('BMI', models.SmallIntegerField(null=True, verbose_name='Body Mass Index')),
        ...
        migrations.AddField(
            model_name='comments',
            name='Related_Event',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='FitApp.Event'),
        ),
    ]
