...
urlpatterns = [
    ...
    # path('portal/login/member/profile/', views.view_profile, name='view_profile'), # profile view
    # # this profile view would need to have fitbit records arranged in the same way that the event tiles were arranged
    # path('portal/login/member/edit_profile', views.edit_profile, name='edit_profile'), # edit profile view
    #
